...
import Migration0041 from "./Migrations/041_ProjectionThreadGoals.ts";
import Migration0042 from "./Migrations/042_ProjectionThreadLastAgentActivity.ts";
...
export const migrationEntries = [
  ...
  [41, "ProjectionThreadGoals", Migration0041],
  [42, "ProjectionThreadLastAgentActivity", Migration0042],
] as const;
